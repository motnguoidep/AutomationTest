...
public class LoginFb {
    ...
    void openBrowserWithDefaultMode() {
        ...
        // Nhập tên người dùng
        driver.findElement(By.name("email")).sendKeys("mò vô đây làm chi? hả?");
        // Nhập mật khẩu
        driver.findElement(By.name("pass")).sendKeys("mò vô đây làm chi "); // Thay thế bằng mật khẩu của bạn
